...
export default function News(){
    ...
    return (
        <div className="news_Fr" style={{fontSize:"24px"}}>
                    ...
                    <div className="s row">
                        ...
                        <div className="newsContent row" id="newsContent">
                            ...
                            <div className="col-12 col-lg-6 order-lg-7">
                                <p style={{fontSize:"30px"}}><Link to={"/"}>【雷神索爾：愛與雷霆】訂票抽獎活動</Link></p>
                            ...
                            <div className="col-12 col-lg-6 order-lg-8"style={{margin:"50px 50px 50px -50px"}}>
                                <p style={{fontSize:"30px"}}><Link to={"/"}>【怪獸與鄧不利多的祕密】票價調整公告</Link></p>
                                <p>【怪獸與鄧不利多的祕密】因片長超過2小時，現場票價以及銀行優惠票價皆調整10元，套票價格不變 並依現場公告為準。</p>
                            </div>
                            ...
                            <div className="col-12 col-lg-6 order-lg-3">
                                <p style={{fontSize:"30px"}}><Link to={"/"}>「臺灣社交距離App」宣導</Link></p>
                            ...
                            <div className="col-12 col-lg-6 order-lg-4"style={{margin:"50px 50px 50px -50px"}}>
                                <p style={{fontSize:"30px"}}><Link to={"/"}>因應政府防疫規定 出入電影場所應佩戴口罩</Link></p>
