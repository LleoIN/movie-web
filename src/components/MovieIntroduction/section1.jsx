...
export default function MovieIntroduction(props) {
        ...
        if (mov !== "" && act !== "") {
            let sec =
                <div id="section1">
                    <div id="movieIntro">
                        <div id="movieTitle">
                            <IoChevronForward style={{ fontSize: "40px", marginTop: "-5px" }}></IoChevronForward>
                            <h3 style={{ fontSize: "28px" }}>電影介紹</h3>
                        </div>
                        <img id="movieImg" src={require(`../../movie_image/${mov.image}`)} alt="" />
                    </div>
                    <div id="movieIntroTxt">
                        <div id="movieIntroTxtTop">
                            <h3 style={{ fontSize: "28px" }}>{mov.name_CN}</h3>
                            <div>
                                <Link to={"/"}>
    ...
    return (
        <div style={{ fontSize: "24px", color: "aliceblue" }}>
            {section ? section : ""}
