  ...
  const cancelcheck =
    <div id="content" className="tab-content">
      <div className="tab-pane active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
        <div id="cancel_form">
          <div>
            <p className="cancel_form_text">確定後將全額退款！</p>
            <button className="order_cnacel_btn btn-primary" onClick={(e) => { deleteticke(e) }}>確認取消</button>
          </div>
        </div>
      </div>
    </div>;
      ...
      <div className="tab-pane active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
        <div id="record" className="list-group">
          ...
          <div id="next_content">
            ...
            <p className="list-group-item-heading">
              劃位座號：
              <p id="categorys">{props.ticket.seat_name}</p>
            </p>
            <p className="list-group-item-heading">
              餐點食物：
            ...
            <button id="download" onClick={() => { handqrcode(props.ticket.seat_name); }} className="btn btn-primary">
              電子票下載
            </button>
