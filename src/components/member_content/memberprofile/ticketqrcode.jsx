    ...
    return(
        <div id="content" className="tab-content">
            <div className="tab-pane active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <button style={{borderColor: "transparent black transparent transparent"}} type="button" onClick={(e)=>{seatnumber(e)}} className="reduce"></button>
                <button style={{borderColor: "transparent transparent transparent black"}} type="button" onClick={(e)=>{seatnumber(e)}} className="add"></button> 
                <div id="down_image">
                    <img src={imgNavigation} alt=''/>
                <div id="down_content">
                    <div><p>2<span>樓</span></p></div>
                    <div style={{color:"black",padddingLeft:"-5px"}}><p>{props.ticket.theatersName}<span>廳</span></p></div>
