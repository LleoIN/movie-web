...
export default function Page2(props) {
    ...
    return (
        <div className="col-md-8 content_fixed" style={{height:"600px",fontSize:"24px"}}>
            ...
            <header className="header_4" style={{margin:"10px 0"}}>
                <abbr>選擇票種張數</abbr>
            </header>
            <div>
                <table style={{margin:"0 0 0 0"}}>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <h4 style={{margin:"20px 0"}}>特價優惠</h4>
                            </td>
                            <td>160元
            ...
            <List cinema={props.cinema} theater={props.theater} price={num} number={number} categorysName={props.categorysName} movieName={props.movieName} movieinfo={props.movieinfo} date={props.date} time={props.time} />
        </div>
    )
}