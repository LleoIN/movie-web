...
export default function Booking(props) {
    ...
    const [theater,settheater] = useState("");//影廳放映廳
        ...
        let tim = props.screen.map((elm,key)=>{
            if(elm.categorysName === movie[0] && elm.cinemasName === cinema && elm.movieName_CN === movie[1] && elm.show_date === e.target.value){
                ...
                return(
                    <tr key={key}>
                        <td>
                            <input type="radio" name="radio" value={[elm.show_time,120-num*1,elm.theatersName]} onClick={(e)=>{changetime(e)}}/>
                        </td>
                        <td>{elm.show_date}</td>
                        <td>{elm.show_time}</td>
    ...
    const page1 =
    <div className="col-md-8 col-7 content_fixed" style={{fontSize:"16px",height:"600px",width:"65%",overflowY: 'scroll',overflowX:'hidden'}}>
        ...
        <div id="divSelectScreeningPanel" className="powerwidget cold-grey">
            ...
            <div id="divSelectScreeningContent" className="inner-spacer_2">
                <form className="orb-form">
                    ...
                    <div className="inbox-new-message from_bottom" style={{width:"100%"}}>
    ...
    return (
        <div className="containersss frontend container_bgcolor" style={{width:"90%",color:"black",padding:"0 50px 0 50px",margin:"100px auto"}}>
            <div className="a row1">
                ...
                {param.id === 'page2'?<Page2 screen={props.screen} ticket={props.ticket} cinema={cinema} theater={theater} categorysName={movie[0]} movieName={movie[1]} movieinfo={movieinfo} date={dateCH} time={timeCH} />:""}
                {param.id === 'page3'?<Page3 screen={props.screen} ticket={props.ticket} cinema={cinema} theater={theater} categorysName={movie[0]} movieName={movie[1]} movieinfo={movieinfo} date={dateCH} time={timeCH} price={price} number={number} />:""}
                {param.id === 'page4'?<Page4 food={props.food} screen={props.screen} ticket={props.ticket} cinema={cinema} theater={theater} categorysName={movie[0]} movieName={movie[1]} movieinfo={movieinfo} date={dateCH} time={timeCH} price={price} number={number} seat={seatName}/>:""}
                {param.id === 'page5'?<Page5 users={props.users} screen={props.screen} cinema={cinema} theater={theater} categorysName={movie[0]} movieName={movie[1]} movieinfo={movieinfo} date={dateCH} time={timeCH} price={price} number={number} seat={seatName} foodName={foodName} foodPrice={foodPrice}/>:""}

                {param.id === 'page1'?<List seat={seatName} cinema={cinema} theater={theater} categorysName={movie[0]} movieName={movie[1]} movieinfo={movieinfo} date={dateCH} time={timeCH} />:""}
